...
```
  ...
  **Mise à jour :** En l'état actuel, cette markup extension ne supporte pas l'utilisation dans un template. Pour une explication et une solution à ce problème, lisez [ce billet](/2009/08/22/wpf-markup-extensions-et-templates/).
